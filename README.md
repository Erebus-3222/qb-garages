...
Edit of qb-garages to allow vehicles to be pulled from any garage.
Just a quick edit,so support is limited but open to PRs 

To Install just overwrite your old garages folder, you will need to change all cars garage in the DB to "public"
...
**Configurations**
* You can only parks ground vehicles in garages of type "public" in config. 
